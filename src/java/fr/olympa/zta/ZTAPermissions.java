...
public class ZTAPermissions{
	...
	public static final OlympaSpigotPermission TAX_MANAGE_COMMAND = new OlympaSpigotPermission(OlympaGroup.MODP);
	...
	public static final OlympaSpigotPermission WEAPONS_MANAGE_COMMAND = new OlympaSpigotPermission(OlympaGroup.MODP);
	...
	public static final OlympaSpigotPermission GLASS_MANAGE_COMMAND = new OlympaSpigotPermission(OlympaGroup.MODP);
	public static final OlympaSpigotPermission PARACHUTE_MANAGE_COMMAND = new OlympaSpigotPermission(OlympaGroup.MODP);
	public static final OlympaSpigotPermission CLAN_PLOTS_COMMAND = new OlympaSpigotPermission(OlympaGroup.ASSISTANT);
	public static final OlympaSpigotPermission CLAN_PLOTS_MANAGE_COMMAND = new OlympaSpigotPermission(OlympaGroup.MODP, new OlympaGroup[] { OlympaGroup.BUILDER, OlympaGroup.DEVP });
	public static final OlympaSpigotPermission MINIGUNS_COMMAND = new OlympaSpigotPermission(OlympaGroup.MODP);
	public static final OlympaSpigotPermission PROBLEM_MONITORING = new OlympaSpigotPermission(OlympaGroup.DEV);
	public static final OlympaSpigotPermission BYPASS_TELEPORT_WAIT_COMMAND = new OlympaSpigotPermission();
	...
	public static final OlympaSpigotPermission ECONOMIES_MANAGE_COMMAND = new OlympaSpigotPermission(OlympaGroup.MODP);
	...
	public static final OlympaSpigotPermission MONEY_COMMAND_MANAGE = new OlympaSpigotPermission(OlympaGroup.MODP);

	public static final OlympaSpigotPermission BACK_COMMAND_INFINITE = new OlympaSpigotPermission(OlympaGroup.MODP);
