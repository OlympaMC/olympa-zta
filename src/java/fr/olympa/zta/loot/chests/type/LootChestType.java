...
public enum LootChestType {
	...
	MILITARY(
			...
			new ItemStackableCreator(1.5, Accessory.CANNON_SILENT),
			new ItemStackableCreator(0.6, Accessory.SCOPE_STRONG),
			new AmmoCreator(7.05, AmmoType.HEAVY, 2, 6, true),
			new AmmoCreator(2.35, AmmoType.CARTRIDGE, 1, 1, true),
			...
			new AmmoCreator(7.52, AmmoType.HEAVY, 3, 7, false),
