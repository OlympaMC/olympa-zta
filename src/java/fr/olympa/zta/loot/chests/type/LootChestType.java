...
public enum LootChestType {
	...
	CIVIL(
			...
			new ItemStackableCreator(0.9, Accessory.CANNON_CAC),
	...
	MILITARY(
			"militaire",
			new ItemStackableCreator(2.2, GunType.P22),
			new ItemStackableCreator(1.1, GunType.SDMR),
			new ItemStackableCreator(1.32, GunType.BARRETT),
			new ItemStackableCreator(1.98, GunType.KSG),
			new ItemStackableCreator(4.4, Knife.SURIN),
			new ItemStackableCreator(1.6, Accessory.STOCK_STRONG),
			new ItemStackableCreator(1, Accessory.CANNON_POWER),
			new ItemStackableCreator(1, Accessory.CANNON_SILENT),
			new ItemStackableCreator(0.4, Accessory.SCOPE_STRONG),
			new AmmoCreator(6.75, AmmoType.HEAVY, 2, 6, true),
			new AmmoCreator(2.25, AmmoType.CARTRIDGE, 1, 1, true),
			new AmmoCreator(7.2, 4, 9),
			new AmmoCreator(7.2, AmmoType.HANDWORKED, 1, 2, false),
			new AmmoCreator(7.2, AmmoType.LIGHT, 1, 4, false),
			new AmmoCreator(7.2, AmmoType.CARTRIDGE, 1, 2, false),
			new AmmoCreator(7.2, AmmoType.HEAVY, 3, 7, false),
			...
			new ArmorCreator(7, ArmorType.MILITARY),
			new QuestItemCreator(3.6, QuestItem.DECHET),
			new QuestItemCreator(3.6, QuestItem.AMAS),
			new MoneyCreator(0.8, PhysicalMoney.BANKNOTE_1, 2, 5)),
	CONTRABAND(
			...
			new ItemStackableCreator(1, Accessory.CANNON_DAMAGE),
