...
public enum LootChestType {
	...
	CIVIL(
			...
			new AmmoCreator(6.3, AmmoType.LIGHT, 1, 4, true),
			new AmmoCreator(2.1, AmmoType.CARTRIDGE, 1, 1, true),
			new AmmoCreator(8.4, 3, 8),
			new AmmoCreator(6.3, AmmoType.HANDWORKED, 1, 4, false),
			new AmmoCreator(6.3, AmmoType.LIGHT, 2, 7, false),
	...
	CONTRABAND(
			...
			new AmmoCreator(7.56, AmmoType.HANDWORKED, 1, 4, true),
			new AmmoCreator(2.1, AmmoType.CARTRIDGE, 1, 1, true),
			new AmmoCreator(6.72, 3, 8),
			new AmmoCreator(7.56, AmmoType.HANDWORKED, 2, 5, false),
