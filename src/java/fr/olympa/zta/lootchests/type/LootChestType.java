...
public enum LootChestType {
	...
	CIVIL(
			"civil",
			new ItemStackableCreator(1.755, GunType.M1911),
			new ItemStackableCreator(1.690, GunType.COBRA),
			new ItemStackableCreator(1.755, GunType.REM_870),
			new ItemStackableCreator(1.755, GunType.UZI),
			new ItemStackableCreator(1.690, GunType.M16),
			new ItemStackableCreator(1.755, GunType.M1897),
			new ItemStackableCreator(2.6, Knife.MATRAQUE),
