...
public enum LootChestType {
	...
	CIVIL(
			...
			new AmmoCreator(6.3, AmmoType.LIGHT, 1, 2, true),
			new AmmoCreator(2.1, AmmoType.CARTRIDGE, 1, 3, true),
			new AmmoCreator(8.4, 1, 3),
			new AmmoCreator(6.3, AmmoType.HANDWORKED, 1, 3, false),
			new AmmoCreator(6.3, AmmoType.LIGHT, 2, 3, false),
			new AmmoCreator(6.3, AmmoType.CARTRIDGE, 1, 3, false),
			new AmmoCreator(6.3, AmmoType.HEAVY, 1, 2, false),
	...
	MILITARY(
			...
			new AmmoCreator(6.3, AmmoType.HEAVY, 1, 3, true),
			new AmmoCreator(2.1, AmmoType.CARTRIDGE, 1, 2, true),
			new AmmoCreator(6.72, 1, 3),
			new AmmoCreator(6.72, AmmoType.HANDWORKED, 1, 1, false),
			new AmmoCreator(6.72, AmmoType.LIGHT, 1, 2, false),
			new AmmoCreator(6.72, AmmoType.CARTRIDGE, 1, 1, false),
			new AmmoCreator(6.72, AmmoType.HEAVY, 1, 3, false),
	...
	CONTRABAND(
			...
			new AmmoCreator(7.56, AmmoType.HANDWORKED, 1, 3, true),
			new AmmoCreator(2.1, AmmoType.CARTRIDGE, 1, 2, true),
			new AmmoCreator(6.72, 1, 3),
			new AmmoCreator(7.56, AmmoType.HANDWORKED, 1, 3, false),
