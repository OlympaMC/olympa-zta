...
public class PlayerSettingsGUI extends OlympaGUI {
	...
	private static final int SLOT_HEALTH_BAR = 4;
	...
	public PlayerSettingsGUI(OlympaPlayerZTA player) {
		...
		inv.setItem(SLOT_HEALTH_BAR, ItemUtils.itemSwitch("Barre de vie", player.parameterHealthBar.get(), SpigotUtils.wrapAndAlign("Affiche la vie des entités avec lesquelles tu te bats en haut de l'écran.", 35).toArray(String[]::new)));
	...
	public boolean onClick(Player p, ItemStack current, int slot, ClickType click) {
		...
		case SLOT_ZONE_TITLE:
			...
			break;
		case SLOT_HEALTH_BAR:
			player.parameterHealthBar.set(ItemUtils.toggle(current));
			break;
